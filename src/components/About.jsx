    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Section Header */}
                <header className="text-center text-gray-800 dark:text-white mb-12" data-aos="fade-down">
             ...
             transition-all duration-300"
                    ...
                    {/* Biodata Section */}
                    <div className="w-full text-gray-800 dark:text-white" data-aos="fade-left">
